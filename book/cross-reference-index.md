...
| API chậm ở production | [Index](phase-07-database/03-index.md), [Execution Plan](phase-07-database/04-execution-plan.md), [N+1](phase-06-persistence/10-n-plus-1.md), [Cache](phase-05-spring/16-cache.md), [HikariCP](phase-08-production/04-hikaricp.md), [Performance Tuning](phase-08-production/11-performance-tuning.md) |
...
| OutOfMemoryError | [Garbage Collection](phase-01-foundation/07-garbage-collection.md), [Runtime Data Areas](phase-01-foundation/04-runtime-data-areas.md), [JVM Tuning](phase-08-production/10-jvm-tuning.md) |
