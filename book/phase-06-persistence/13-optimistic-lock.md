...
- Your application starts creating duplicate records even though you're checking if they already exist. How would you fix it? (see also Isolation, Lock, Unique Index, Pessimistic Lock)
