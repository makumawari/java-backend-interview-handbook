...
> Phase: Phase 9 — Architecture
> Chapter slug: `resilience-patterns`

## Metadata

```yaml
Chapter: Resilience Patterns (Circuit Breaker, Retry, Bulkhead, Timeout)
Phase: Phase 9 — Architecture
Difficulty: TODO (★ to ★★★★★)
...
- One slow external API causes your entire application to become slow. Which resilience patterns would you apply?
