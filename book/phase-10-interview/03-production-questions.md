...
> Phase: Phase 10 — Interview
> Chapter slug: `production-questions`

## Metadata

```yaml
Chapter: Production Questions
Phase: Phase 10 — Interview
Difficulty: TODO (★ to ★★★★★)
...
- Everything works in staging, but the application fails immediately after deploying to production. What are the first things you would verify?
